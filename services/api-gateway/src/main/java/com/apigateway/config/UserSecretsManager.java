...
public class UserSecretsManager {
    ...
    public Integer getVaultKeyVersionFromToken(String token) throws JsonProcessingException {
        ...
        String rsaKeyVersion = payloadMap.getOrDefault(ApplicationConstants.RSA_KEY_VERSION, "0").toString();
    ...
    public String getSpecificVersion(int version) {
        ...
        return rsaKeyCache.getOrDefault(ApplicationConstants.PUBLIC_KEY, publicKey);
    }


    public RSAPublicKey readPublicKey(String pubKey) throws Exception {
        log.info("Reading public key. UserSecretsManager API GATEWAY::{}", pubKey);
        try {
