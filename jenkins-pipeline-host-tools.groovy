    ...
    stages {
            ...
            steps {
                ...
                script {
                    try {
                        ...
                        echo 'Trying without credentials (for public repo)...'
                        bat 'git clone -b main https://github.com/helal6651/Digital-bank.git .'
                    }
                }
            }
        }
        ...
        stage('Build and Push Docker Images') {
            parallel {
                ...
                stage('Account Service Docker') {
                    steps {
                        echo 'Building and pushing account-service Docker image...'
                        dir('services/account-service') {
        ...
        stage('Deploy to Kubernetes') {
            steps {
                ...
                script {
                    // Execute kubectl commands directly on host using PowerShell
                    bat '''
